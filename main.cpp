	...
	do
	{
		...
		if (opcion == 3)
		{
			...
			do
			{
				...
				if (filas2 != filas1 || columnas2 != columnas1)
				{
					cout<<"No se puede realizar la resta, el tamaño de la matriz2 debe ser igual a la matriz1"<<endl;
					break;
				}
				int** m2 = new int* [filas2];
				for (int j = 0; j < filas2; j++) {
		...
		if (opcion == 4)
		{
			...
			do
			{
				...
				if (columnas1 != filas2)
				{
					cout<<"No se puede realizar la multiplicaion, el numero de columnas de la matriz1 debe ser igual al numero de filas de la matriz1"<<endl;
					break;
				}
				int** m2 = new int* [filas2];
				for (int j = 0; j < filas2; j++) {
				...
				cout<<"Matriz 2 :"<<endl;
				cout<<matriz2<<endl;
				Matriz multiplicacion(filas2, columnas2);
		...
		if (opcion == 6)
		{
			...
			do
			{
				...
				if (filas2 != filas1 || columnas2 != columnas1)
				{
					cout<<"No se puede realizar la comparacion, el tamaño de la matriz2 debe ser igual a la matriz1"<<endl;
					break;
				}
				int** m2 = new int* [filas2];
				for (int j = 0; j < filas2; j++) {
				...
				cout<<"Matriz 2 :"<<endl;
				cout<<matriz2<<endl;
				Matriz comparacion(filas2, columnas2);
